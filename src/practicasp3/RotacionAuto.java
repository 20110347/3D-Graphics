 ...
 * @author Saul
 */
public class RotacionAuto extends JFrame implements Runnable {
...
//    int sx = 0;
    ...
    public void run() {
        while (true) {
            ...
            objCube.rotateCube(5, objCube.rx);
            objCube.rotateCube(5, objCube.ry);
            objCube.rotateCube(5, objCube.rz);
        }
